...
IndexedGraph IndexedGraph::Creator::Prepare(const Expr& body) {
...
void IndexedGraph::Creator::Update(const Expr& node,
...
void IndexedGraph::Creator::AddNode(const tvm::Object* key, Attr* attr) {
  auto it = graph_.node_map.find(key);
...
// Post order tree
void IndexedGraph::Creator::VisitExpr_(const FunctionNode* op) {
...
void IndexedGraph::Creator::VisitExpr_(const ConstantNode* op) {
...
void IndexedGraph::Creator::VisitExpr_(const CallNode* call) {
...
void IndexedGraph::Creator::VisitExpr_(const TupleNode* op) {
...
void IndexedGraph::Creator::VisitExpr_(const TupleGetItemNode* op) {
...
void IndexedGraph::Creator::VisitExpr_(const VarNode* op) {
...
void IndexedGraph::Creator::VisitExpr_(const LetNode* op) {
...
void IndexedGraph::Creator::VisitExpr_(const IfNode* op) {
...
void IndexedGraph::Creator::VisitExpr_(const RefCreateNode* op) {
  this->Update(op->value, nullptr, kOpaque);
  ExprVisitor::VisitExpr_(op);
...
void IndexedGraph::Creator::VisitExpr_(const RefReadNode* op) {
...
void IndexedGraph::Creator::VisitExpr_(const RefWriteNode* op) {
  this->Update(op->ref, nullptr, kOpaque);
  this->Update(op->value, nullptr, kOpaque);
  ExprVisitor::VisitExpr_(op);
...
void IndexedGraph::Creator::VisitExpr_(const MatchNode* op) {
...
IndexedGraph::Node* Partitioner::InitNode(std::string op_type, IndexedGraph::Node* src, size_t index){
...
void Partitioner::collectGroupNodes(IndexedGraph::Node* src, Group* group){
...
void Partitioner::dump(IndexedGraph::Node* node){
  os << "node[" << node->index << "], "
       <<node->attr->type
       << " outputs=[";
...
IndexedGraph::Node* Partitioner::check(IndexedGraph::Node* ref, IndexedGraph::Node* node){
...
std::vector<Partitioner::Group*> Partitioner::match(support::Arena* arena, std::vector<IndexedGraph::Node*> graph){
  os<<"\n\n[Partition]\n";
  arena_ = arena;
...
// Run the transform
Expr OpFuser::Transform(const Expr& body) {
  os << "\n\n[OpFuseHW]\n";
  // setup the group map.
...
void OpFuser::Update(std::vector<Partitioner::Group*> groups){
...
Expr OpFuser::VisitExpr_(const FunctionNode* fn_node) {
...
// Transform calls.
Expr OpFuser::VisitExpr_(const CallNode* call) {
...
Array<Expr> OpFuser::GetNewArguments(const tvm::Array<Expr>& args, Partitioner::Group* current_group) {
  Array<Expr> new_args;
  for (auto arg : args) {
...
Expr OpFuser::MakeNewFunction(Partitioner::Group* group, Type ret_type, Expr body) {
...
Expr OpFuser::VisitExpr_(const TupleNode* tuple) {
...
Expr OpFuser::VisitExpr_(const TupleGetItemNode* tuple_get) {
