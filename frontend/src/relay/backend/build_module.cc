...
class RelayBuildModule : public runtime::ModuleNode {
 ...
 protected:
  ...
  IRModule Optimize(
    ...
    pass_seqs.push_back(transform::ToNCHWLayout());
    pass_seqs.push_back(transform::Peephole());
    //pass_seqs.push_back(transform::PrintIR(false));
    
    //pass_seqs.push_back(transform::ExplicitPad());
    pass_seqs.push_back(transform::CanonicalizeConcatPos());     
    pass_seqs.push_back(transform::Peephole());
    
    pass_seqs.push_back(transform::PrintIR(false));
    pass_seqs.push_back(transform::FuseOpHWCustom());   
    pass_seqs.push_back(transform::PrintIR(false));

    bool quantize = true;
    // bool quantize = false;
    bool use_post_padding = true;
    //bool use_post_padding = false;
    pass_seqs.push_back(transform::GenIR(quantize, use_post_padding));
    //pass_seqs.push_back(transform::PrintIR(false));
  ...
  void BuildRelay(
    ...
    IRModule relay_module = Optimize_legacy(func, targets_, params);
